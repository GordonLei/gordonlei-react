      ...
      <footer className="flex flex-col md:flex-row">
          ...
          <div className="flex items-center float-right">
            ...
            <a href="https://github.com/GordonLei">
              <img className= "h-10 mb-2 mx-4 justify-center" src= {process.env.PUBLIC_URL + "/img/favicons/github.png"} alt="missing SkillsCard"></img>
            </a>
            <a href="https://linkedin.com/in/gordon-lei-a1b238181">
              <img className= "h-10 mb-2 mx-4 justify-center" src= {process.env.PUBLIC_URL + "/img/favicons/LI-In-Bug.png"} alt="missing SkillsCard"></img>
            </a>
          </div>
      </footer>
    </section>
