      ...
      <div className="mx-8 lg:mx-48 h-96 content-center flex flex-col md:flex-row md:w-auto md:flex-grow md:flex md:items-center ">
        <div className = "inline-block h-full md:mx-0 lg:mx-20 flex-row md:flex-col">
          <div className="flex-col md:flex-none ">
            ...
            <div className="font-medium text-2xl p-2 text-metropolis_alpha_yellow"> Undergraduate at New York University Tandon School of Engineering </div>
            <div className="font-normal text-xl p-2 text-metropolis_alpha_red grid grid-cols-1 divide-y-4"> Email:  
        ...
        <div className="inline-block h-full">
          <img className="h-full w-auto mb-8" src= {process.env.PUBLIC_URL + '/img/mountains.jpg'}  alt="profile" />
          <div className = "flex flex-row place-content-center space-x-8 md:space-x-20 ">
            <span className="w-16 h-16  p-2 rounded-xl bg-white opacity-50 border-4 border-metropolis_alpha_yellow hover:border-metropolis_alpha_red hover:opacity-100  ease-in duration-500">
              <a className="" href="https://github.com/GordonLei">
                <img className= "sm:w-min justify-center" src= {process.env.PUBLIC_URL + "/img/favicons/github.png"} alt="missing SkillsCard"></img>
              </a>
            </span>
            <span className="w-16 h-16 p-2 rounded-xl bg-white opacity-50 border-4 border-metropolis_alpha_yellow hover:border-metropolis_alpha_red hover:opacity-100  ease-in duration-500">
              <a className="" href="https://linkedin.com/in/gordon-lei-a1b238181">
                <img className= "h-full justify-center" src= {process.env.PUBLIC_URL + "/img/favicons/LI-In-Bug.png"} alt="missing SkillsCard"></img>
              </a>
            </span>
            <span className="w-16 h-16 p-2 rounded-xl bg-white opacity-50 border-4 border-metropolis_alpha_yellow hover:border-metropolis_alpha_red hover:opacity-100  ease-in duration-500">
              <a className="" href="mailto: lei.gordon@nyu.edu">

                <img className= "h-full justify-center" src= {process.env.PUBLIC_URL + "/img/favicons/email.png"} alt="missing SkillsCard"></img>
              </a>
            </span>
          </div>
        </div>
